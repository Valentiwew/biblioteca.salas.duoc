...
public class EstudianteControllerTest {
    ...
    public void testGetAllEstudiantes() throws Exception {
        ...
        when(estudianteService.listarTodos()).thenReturn(List.of(estudiante));
    ...
    public void testGetEstudianteById() throws Exception {
        ...
        when(estudianteService.obtenerPorId(1)).thenReturn(estudiante);
    ...
    public void testCreateEstudiante() throws Exception {
        ...
        when(estudianteService.guardar(any(Estudiante.class))).thenReturn(estudiante);
    ...
    public void testDeleteEstudiante() throws Exception {
        ...
        verify(estudianteService, times(1)).eliminarPorId(1);
    }
}
